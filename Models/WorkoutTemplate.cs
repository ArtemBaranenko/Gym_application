public class WorkoutTemplate
{
    ...
    {
        IdWorkout = idWorkout;
        WorkoutName = workoutName ?? "Null Name";
        Exercises = exercises;
        Type = type;
    }
    ...
    {
        var exercisesStr = string.Join(",", Exercises.Select(exercisesStr => exercisesStr.ExerciseName));
        return $"Workout Name: {WorkoutName}| Exercises: {exercisesStr}";
    }
}
